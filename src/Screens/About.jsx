export default function About() {
  return (
    <main className="scroll-smooth bg-neutral-900 min-h-screen text-neutral-100 flex flex-col gap-2">
      <section className="px-4 text-neutral-50 flex flex-col gap-4 mt-10 **:duration-300 **:ease-linear">
        <img
        ...
        <main className="flex flex-col">
          ...
          <p className="mt-4 text-neutral-400 font-light">
            ...
            which I use to build engaging and responsive user interfaces. I also
            bring valuable experience from internships as a UI/UX designer,
            blending design thinking with technical implementation.
            <br />
            <br /> Outside of development, I enjoy book reading and continuously
            learning new things to expand my knowledge and skills.
            <br />
            <br /> Through this portfolio, I aim to highlight my passion for
            creating great digital experiences and demonstrate my growth as a
            frontend developer. Feel free to explore my work and connect!
          </p>
          ...
          <a
            ...
            className="flex mb-[193px] items-center gap-3 text-sm text-neutral-200 pt-8 pb-20 "
          >
